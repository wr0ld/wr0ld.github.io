...
var BODY_FONT = '500 17px "Helvetica Neue", Helvetica, Arial, sans-serif';
var LINK_FONT = '600 17px "Helvetica Neue", Helvetica, Arial, sans-serif';
var CODE_FONT = '600 14px "SF Mono", ui-monospace, Menlo, Monaco, monospace';
var CHIP_FONT = '700 12px "Helvetica Neue", Helvetica, Arial, sans-serif';
var TEXT_STYLES = {
  body: {
...
var LINE_START_CURSOR = { segmentIndex: 0, graphemeIndex: 0 };
var LINE_HEIGHT = 34;
var LAST_LINE_BLOCK_HEIGHT = 24;
var NOTE_SHELL_CHROME_X = 40;
var BODY_MIN_WIDTH = 260;
var BODY_DEFAULT_WIDTH = 516;
var BODY_MAX_WIDTH = 760;
var PAGE_MARGIN = 28;
var CHIP_CHROME_WIDTH = 22;
var UNBOUNDED_WIDTH = 1e5;
var collapsedSpaceWidthCache = /* @__PURE__ */ new Map();
var INLINE_BOUNDARY_GAP = measureCollapsedSpaceWidth(BODY_FONT);
var INLINE_SPECS = [
  ...
  { kind: "text", text: " docs; the review bundle now includes \u4E2D\u6587 labels, \u0639\u0631\u0628\u064A fallback, and one more launch pass \u{1F680} for ", style: "body" },
...
var items = prepareInlineItems(INLINE_SPECS);
var st = {
  events: {
    sliderValue: null
  },
...
function prepareInlineItems(specs) {
  const items2 = [];
  let pendingGap = 0;
...
function layoutInlineItems(items2, maxWidth) {
  const lines = [];
  const safeWidth = Math.max(1, maxWidth);
  let itemIndex = 0;
  let textCursor = null;
  while (itemIndex < items2.length) {
    const fragments = [];
    let lineWidth = 0;
...
function render() {
  ...
  const noteBodyHeight = lineCount === 0 ? LAST_LINE_BLOCK_HEIGHT : (lineCount - 1) * LINE_HEIGHT + LAST_LINE_BLOCK_HEIGHT;
