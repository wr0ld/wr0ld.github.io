...
var items = [
  ...
  },
  {
    id: "mixed",
    title: "Section 4",
    text: "AGI \u6625\u5929\u5230\u4E86. \u0628\u062F\u0623\u062A \u0627\u0644\u0631\u062D\u0644\u0629 \u{1F680} and the long URL is https://example.com/reports/q3?lang=ar&mode=full. Nora wrote \u201Cplease keep 10\u202F000 rows visible,\u201D Mina replied \u201Ctrans\xADatlantic labels are still weird.\u201D"
  }
];
var st = {
  openItemId: "shipping",
...
function render(_now) {
  ...
  if (firstCopy === void 0 || firstInner === void 0) return false;
  ...
  for (let index = 0; index < items.length; index++) {
    ...
    panelMeta.push(`Measurement: ${metrics.lineCount} lines \xB7 ${Math.round(metrics.height)}px`);
  }
