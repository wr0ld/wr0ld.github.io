import"./chunk-Q2LVA6OR.js";import"./chunk-6QL6PBVA.js";import"./chunk-DS3JAVIL.js";import"./chunk-WWVVFTZ7.js";import"./chunk-7EFC7LZD.js";import"./chunk-GZWNT6EQ.js";import"./chunk-QQHTKLZS.js";import"./chunk-DTLCNPG3.js";import"./chunk-DWM6Z6KC.js";import"./chunk-CXDM4SZK.js";import"./chunk-5DIFOE2K.js";import"./chunk-BQ2GQ3C2.js";import"./chunk-RBMRP7GT.js";import"./chunk-QD7RK3A4.js";import"./chunk-G5HJZQLJ.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-YVY7FGQB.js";var i="samplerFragmentAlternateDeclaration",O=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=O);var a="pbrFragmentSamplersDeclaration",T=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=T);var n="pbrBlockAlbedoOpacity",L=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=L);var f="pbrBlockReflectivity",_=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=_);var o="pbrBlockAmbientOcclusion",M=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=M);var t="pbrBlockAlphaFresnel",F=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=F);var c="pbrBlockAnisotropic",D=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=D);var l="pbrBlockReflection",h=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=h);var d="pbrBlockSheen",g=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=g);var s="pbrBlockClearcoat",P=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=P);var E="pbrBlockIridescence",U=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=U);var m="pbrBlockSubSurface",b=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=b);var S="pbrBlockNormalFinal",B=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=B);var R="pbrBlockLightmapInit",y=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=y);var C="pbrBlockGeometryInfo",G=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=G);var u="pbrBlockReflectance",V=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=V);var p="pbrBlockDirectLighting",x=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=x);var v="pbrBlockFinalLitComponents",H=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=H);var A="pbrBlockFinalUnlitComponents",W=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=W);var I="pbrBlockFinalColorComposition",Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=Y);var r="pbrPixelShader",N=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=N);var Br={name:r,shader:N};export{Br as pbrPixelShaderWGSL};
