import"./chunk-6QL6PBVA.js";import"./chunk-PMLDCXYL.js";import"./chunk-DS3JAVIL.js";import"./chunk-GZWNT6EQ.js";import"./chunk-QQHTKLZS.js";import"./chunk-DTLCNPG3.js";import"./chunk-DWM6Z6KC.js";import"./chunk-CXDM4SZK.js";import"./chunk-5DIFOE2K.js";import"./chunk-BQ2GQ3C2.js";import"./chunk-RBMRP7GT.js";import"./chunk-QD7RK3A4.js";import"./chunk-G5HJZQLJ.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-YVY7FGQB.js";var a="openpbrFragmentSamplersDeclaration",E=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=E);var o="openpbrNormalMapFragmentMainFunctions",h=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=h);var t="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=N);var n="openpbrDielectricReflectance",R=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=R);var i="openpbrConductorReflectance",L=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=L);var f="openpbrBlockAmbientOcclusion",A=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=A);var l="openpbrGeometryInfo",F=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=F);var c="openpbrIblFunctions",T=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=T);var s="openpbrNormalMapFragment",O=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=O);var m="openpbrBlockNormalFinal",b=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=b);var d="openpbrBaseLayerData",C=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=C);var u="openpbrCoatLayerData",M=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=M);var p="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=D);var _="openpbrFuzzLayerData",x=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=x);var g="openpbrEnvironmentLighting",G=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=G);var v="openpbrDirectLightingInit",P=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=P);var S="openpbrDirectLighting",z=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=z);var r="openpbrPixelShader",I=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=I);var _r={name:r,shader:I};export{_r as openpbrPixelShaderWGSL};
