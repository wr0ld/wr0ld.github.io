import{a as e}from"./chunk-L3UYHT7M.js";var o="lightFragmentDeclaration",s=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=s);var t="lightUboDeclaration",c=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);var i="shadowsFragmentFunctions",l=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=l);var a="reflectionFunction",v=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
result.Diffuse=LTCEvaluate( normal,viewDir,position,mat3( 1.0 ),rectCoords );return result;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);
