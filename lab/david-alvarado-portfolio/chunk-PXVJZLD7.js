...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=R);var n="openpbrFragmentSamplersDeclaration",N=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);var t="openpbrNormalMapFragmentMainFunctions",S=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=S);var r="openpbrNormalMapFragmentFunctions",A=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A);var a="openpbrDielectricReflectance",F=`struct ReflectanceParams
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=F);var l="openpbrConductorReflectance",L=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=L);var f="openpbrBlockAmbientOcclusion",T=`struct ambientOcclusionOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=T);var c="openpbrGeometryInfo",O=`struct geometryInfoOutParams
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=C);var d="openpbrNormalMapFragment",b=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=b);var m="openpbrBlockNormalFinal",D=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=D);var u="openpbrBaseLayerData",M=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=M);var _="openpbrCoatLayerData",P=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=P);var p="openpbrThinFilmLayerData",G=`#ifdef THIN_FILM
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=G);var g="openpbrFuzzLayerData",x=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=x);var E="openpbrEnvironmentLighting",z=`#ifdef REFLECTION
#ifdef FUZZ
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=z);var I="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=y);var v="openpbrDirectLighting",U=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=U);var o="openpbrPixelShader",h=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=h);var So={name:o,shader:h};export{So as openpbrPixelShader};
