import"./chunk-O2N2RPUF.js";import"./chunk-4VGCXHN5.js";import"./chunk-7HJLIQQD.js";import"./chunk-VZNCGOTS.js";import"./chunk-RINQL4RT.js";import"./chunk-GPSDXLUX.js";import"./chunk-OXLTDKUZ.js";import"./chunk-XAO7YOQZ.js";import"./chunk-VEV4L6CQ.js";import"./chunk-B3FDBPVZ.js";import"./chunk-VJIYOY3Y.js";import"./chunk-3WT3E6D7.js";import"./chunk-JTBODENQ.js";import"./chunk-BQPQ6TSI.js";import"./chunk-FJN7KTAM.js";import{a as e}from"./chunk-L3UYHT7M.js";import"./chunk-YVY7FGQB.js";var n="pbrFragmentDeclaration",_=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=_);var a="samplerFragmentAlternateDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=M);var r="pbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);var o="pbrBlockAlbedoOpacity",D=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=D);var f="pbrBlockReflectivity",F=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);var t="pbrBlockAmbientOcclusion",g=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=g);var c="pbrBlockAlphaFresnel",P=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=P);var l="pbrBlockAnisotropic",U=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=U);var d="pbrBlockReflection",b=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=b);var s="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=B);var E="pbrBlockClearcoat",y=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=y);var R="pbrBlockIridescence",G=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=G);var C="pbrBlockSubSurface",V=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=V);var m="pbrBlockReflectance0",H=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=H);var S="pbrClusteredLightingFunctions",x=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=x);var u="pbrBlockNormalFinal",W=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=W);var A="pbrBlockLightmapInit",k=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=k);var I="pbrBlockGeometryInfo",Y=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Y);var v="pbrBlockReflectance",X=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=X);var N="pbrBlockDirectLighting",w=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=w);var T="pbrBlockFinalLitComponents",K=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=K);var O="pbrBlockFinalUnlitComponents",z=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=z);var p="pbrBlockFinalColorComposition",Z=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Z);var i="pbrPixelShader",L=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=L);var $i={name:i,shader:L};export{$i as pbrPixelShader};
