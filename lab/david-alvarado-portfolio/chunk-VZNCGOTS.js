import{a as e}from"./chunk-L3UYHT7M.js";var t="pbrFragmentExtraDeclaration",E=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=E);var o="subSurfaceScatteringFunctions",h=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=h);var i="importanceSampling",L=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=L);var a="pbrHelperFunctions",p=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=p);var r="pbrDirectLightingSetupFunctions",D=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=D);var n="pbrDirectLightingFalloffFunctions",S=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=S);var l="hdrFilteringFunctions",m=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=m);var f="pbrDirectLightingFunctions",v=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=v);var c="pbrIBLFunctions",A=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=A);var s="pbrBlockNormalGeometric",N=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=N);var d="pbrBlockImageProcessing",C=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=C);var g="pbrBlockPrePass",_=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var u="pbrDebug",I=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=I);
