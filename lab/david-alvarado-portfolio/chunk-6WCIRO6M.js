...
gl_FragColor=vec4(0.0,0.0,0.0,0.0);else{gl_FragColor=texture2D(textureSampler,tc);}}`;r.ShadersStore[e]||(r.ShadersStore[e]=t);var o={name:e,shader:t};export{o as vrDistortionCorrectionPixelShader};
